                ...
                <tbody>
                    ...
                    foreach ($kategori as $k) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?=
                                            base_url('buku/ubahBuku/') . $k['id']; ?>" class="badge badge-info"><i class="fas fa-edit"></i> Ubah</a><a href="<?= base_url('buku/hapusbuku/') . $k['id']; ?>" onclick="retur confirm('Kamu yakin akan menghapus <?= $judul . ' ' . $k['kategori']; ?>?');" class="badge badge-danger"><i class="fas fa-trash"></i>Hapus</a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
